...
class LargeMartItemsDb{
  ...
  Future<Database> createDatabase() async {
    return await openDatabase(
        ...
        onCreate: (db, version) {
      return db.execute(
    "CREATE TABLE MartItem(l TEXT PRIMARY KEY, t TEXT, d TEXT, s TEXT, i TEXT, p TEXT, k TEXT, b TEXT, h TEXT, m TEXT, n TEXT, q TEXT)",);
    },
    version: 1,);
  }
  ...
  Future<void> clearAllItems() async {
    ...
    // await db.delete('MartItem');
      await db.delete('MartItem', where: '1');
  }
  ...
  Future<List<MartItem>> getMartItems() async {
    ...
    final List<Map<String, dynamic>> maps = await db.query('MartItem');
