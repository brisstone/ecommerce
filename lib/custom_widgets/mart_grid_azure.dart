...
class MartGridAzure extends StatelessWidget {

  MartGridAzure({this.smitem, this.onPressedFunc, this.context }){
    setItemDets();
  }
                  ...
                  children: [
                    ...
                    Expanded(
                      ...
                      child: Text(price, textAlign: TextAlign.left, style: TextStyle(
                          color: kThemeOrange, fontWeight: FontWeight.bold),),
                    ),
                    SizedBox(height:10),
                  ],
                ),
  ...
  Future<void> setItemDets() async {
    ...
    imageUrl= uGetAzurePicUrl(smitem.P);// kUrlStart+smitem.P.replaceAll(kUrlStart, '');
  }
}
